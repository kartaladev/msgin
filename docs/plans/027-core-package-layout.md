...
| Branch conflicts with in-flight feature work | Run this window **before** the gin binding *(then pencilled in as Plan 028; **corrected 2026-08-22, [Plan 030](030-post-029-maintenance.md) Task 3** — 028 was consumed by [nil option elements](028-nil-option-elements.md), and the gin increment is now **unnumbered until it is written**)* or any new adapter; blast radius grows with every adapter landed first |
