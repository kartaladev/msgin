...
type QueueChannel struct {
	store msgin.ChannelStore
}

var (
	_ msgin.OutboundAdapter   = (*QueueChannel)(nil)
	_ msgin.PollingSource     = (*QueueChannel)(nil)
	_ msgin.LiveValueSource   = (*QueueChannel)(nil)
	_ msgin.NativeReliability = (*QueueChannel)(nil)
)
...
func NewQueueChannel(store msgin.ChannelStore) (*QueueChannel, error) {
	if store == nil {
...
func (q *QueueChannel) Send(ctx context.Context, msg msgin.Message[any]) error {
...
func (q *QueueChannel) Poll(ctx context.Context, max int) ([]msgin.Delivery, error) {
...
func (q *QueueChannel) native() (msgin.NativeReliability, bool) {
	nr, ok := q.store.(msgin.NativeReliability)
	return nr, ok
}
